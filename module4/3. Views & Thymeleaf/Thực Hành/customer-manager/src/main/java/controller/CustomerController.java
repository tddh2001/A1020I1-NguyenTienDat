...
public class CustomerController {
    ...
    public String update(@ModelAttribute Customer customer, RedirectAttributes redirectAttributes){
        ...
        redirectAttributes.addFlashAttribute("msg", "Update customer with id: "+customer.getId() + " success");
        return "redirect:/";
    }
    ...
    public String delete(@PathVariable int id, RedirectAttributes redirectAttributes){
        ...
        redirectAttributes.addFlashAttribute("msg", "Delete customer: "+temp+" success");
        return "redirect:/";
    }
}
