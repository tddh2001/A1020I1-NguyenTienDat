...
import com.codegym.quanlytinh.service.DuplicateProvinceException;
...
public class ProvinceController {
    ...
    public String create(Model model, Province province, RedirectAttributes redirectAttributes){
        ...
        }catch (DuplicateProvinceException e){
    ...
    public String edit(Province province, Model model, RedirectAttributes redirectAttributes)throws DuplicateProvinceException{
        provinceService.save(province);
        model.addAttribute("province", province);
        redirectAttributes.addFlashAttribute("msgEdit", "Edit province successfully");
        return "redirect:/provinces";
    }
    @ExceptionHandler(DuplicateProvinceException.class)
