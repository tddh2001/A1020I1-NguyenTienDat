    ...
    <div class="row">
        <article class="col-sm-12">
            <form action="/users?action=edit" method="post">
                ...
                <table>
                    <tr>
                        <th style="text-align: center; padding: 0%;" colspan="2"><h3>Edit User</h3></th>
                    </tr>
                    <tr>
                        <th><p>User Name</p></td>
                        <td><input value="${user.name}" type="text" name="name" required></td>
                    </tr>
                    <tr>
                        <th><p>Email</p></td>
                    ...
                    <tr>
                        <th><p>Country</p></td>
                        <td><input value="${user.country}" type="text" name="country" required></td>
                    </tr>
                    <tr>
                        <td></td>
    ...
    <footer class="card-footer row">
        <div id="map" class="col-sm-10">
            <div class="map">
                ...
                <a style="text-decoration: none;color: rgb(2, 40, 255);" href="" target="_blank">Cơ sở 2: Ngô
                    Quyền</a>
